...
public class Snake extends JFrame {
    ...
    public Snake() {
        ...
        btnCerrar.setBounds(10, 10, 70, 70);
        btnCerrar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                System.exit(0);
            }
        });
        imagenSnake.add(btnCerrar);*/
    ...
    public class ImagenSnake extends JPanel {
        public void paintComponent(Graphics g) {
            ...
            g.setColor(new Color(149, 0, 255));
            g.fillRect(comida.x,comida.y,widthPoint,heightPoint);

            if(gameOver) {
                g.setFont(new Font("TimesRoman", Font.BOLD, 20));
                g.drawString("Perdiste ;(", 300, 200);
                g.drawString("Puntaje: "+(listaPosiciones.size()-1), 300, 240);

                g.setFont(new Font("TimesRoman", Font.BOLD, 20));
                g.drawString("Presiona N si quieres volver a jugar", 100, 320);
                g.drawString("O si quieres salir presiona el boton ESC", 100, 340);
            }
        }
    }
